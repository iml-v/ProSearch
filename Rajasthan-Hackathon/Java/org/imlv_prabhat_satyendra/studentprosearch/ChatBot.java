...
import org.imlv_prabhat_satyendra.studentprosearch.Helpers.DbHelper;
...
public class ChatBot {
    ...
    ChatBot(final AppCompatActivity parentActivity) {
        ...
        messageListView = ((ListView) parentActivity.findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.message_list));
        ...
        parentActivity.findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.send_message).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText editText = (EditText) parentActivity.findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.new_message);
    ...
    private void addDelayedChatBotMessage(final BotChatMessage botChatMessage, final long delay) {
        ...
        final ImageView botImage = (ImageView) parentActivity.findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.bot_image);
        botImage.setImageResource(org.imlv_prabhat_satyendra.studentprosearch.R.drawable.typing_bot);
            ...
            public void run() {
                ...
                parentActivity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        botImage.setImageResource(org.imlv_prabhat_satyendra.studentprosearch.R.drawable.default_bot);
                        scrollMyListViewToBottom();
                    }
                });
            }
