...
public class HomeWebFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(org.imlv_prabhat_satyendra.studentprosearch.R.layout.fragment_home_web, container, false);
        layoutView = v;

        cardAnswerHashMap = ((HomeActivity) getActivity()).cardAnswerHashMap;

        //populate cards
        mFlashCardsList = (CardListView) v.findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.flashcardsList);
