...
public class ConceptListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(org.imlv_prabhat_satyendra.studentprosearch.R.layout.scan_concept_row, parent, false);

            // create a new "Holder" with subviews
            holder = new ViewHolder();
            holder.conceptName = (TextView) convertView.findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.concept_text);
            holder.conceptIndex = (TextView) convertView.findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.concept_index);
