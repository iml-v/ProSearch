...
import org.imlv_prabhat_satyendra.studentprosearch.fab.FloatingActionButton;
...
public class FlashCardsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.imlv_prabhat_satyendra.studentprosearch.R.layout.activity_flash_cards);

        cardAnswerHashMap = new HashMap<>();

        //populate cards
        mFlashCardsList = (CardListView) findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.flashcardsList);
        ...
        for (int i = 0; i < dbCardsList.size(); i++) {
            Log.d("i3t04t943t43t43", mCardAdapter.getView(i, null, mFlashCardsList).findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.list_cardId1).toString());
            Card card = new Card(this);
            ((CardView)(mCardAdapter.getView(i, null, mFlashCardsList).findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.list_cardId1))).setCard(card);
...
//            mCardAdapter.getView(i, null, mFlashCardsList).findViewById(R.id.transparent_layer_card1).performClick();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(org.imlv_prabhat_satyendra.studentprosearch.R.menu.menu_flash_cards, menu);
        return true;
    }
