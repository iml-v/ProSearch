...
import org.imlv_prabhat_satyendra.studentprosearch.Helpers.EditTextPreIme;
...
public class ReaderActivity extends AppCompatActivity implements View.OnScrollChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.imlv_prabhat_satyendra.studentprosearch.R.layout.activity_reader);
        qMode = false;
        Intent it = getIntent();
        ...
        contentWV = (WebView) findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.document_content);

        contentWV.loadDataWithBaseURL("file:///android_asset/", content, "text/html; charset=utf-8", "utf-8", "");

        contentSV = (ScrollView) findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.content_scroll);
        ...
        questionFab = (FloatingActionButton) findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.fab);
        questionFab.setOnClickListener(this);

        fabBadge = (TextView) findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.fab_badge);
        fabBadge.bringToFront();
        fabBadge.setVisibility(View.GONE);

        toggleFab = (FloatingActionButton) findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.toggle_menu_item);
        ...
        chatScreen = (LinearLayout) findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.chat_screen);
        messageHolder = (EditTextPreIme) findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.new_message);
        messageHolder.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (hasFocus) {
                    ...
                    final ImageView botImage = (ImageView) findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.bot_image);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(org.imlv_prabhat_satyendra.studentprosearch.R.menu.menu_reader, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case org.imlv_prabhat_satyendra.studentprosearch.R.id.action_q_toggle:
                if(qMode){
    ...
    public void onClick(View v) {
        switch(v.getId()) {
            case org.imlv_prabhat_satyendra.studentprosearch.R.id.fab:
                if (chatBot == null)
                    chatBot = new ChatBot(currObject);
                zoomImageFromThumb(questionFab, org.imlv_prabhat_satyendra.studentprosearch.R.id.chat_expanded);
                chatBot.start();
                break;
            case org.imlv_prabhat_satyendra.studentprosearch.R.id.toggle_menu_item:
                if(qMode){
    ...
    private void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.container)
