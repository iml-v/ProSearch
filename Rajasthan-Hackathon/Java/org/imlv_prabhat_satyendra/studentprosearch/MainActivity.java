...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.imlv_prabhat_satyendra.studentprosearch.R.layout.activity_main);
        selectFile = (Button) findViewById(org.imlv_prabhat_satyendra.studentprosearch.R.id.select_file);
